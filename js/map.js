...
window.onload = function() {
  ...
  var testData = {
    ...
    var map = new L.Map('map-canvas', {
      center: new L.LatLng(42.6586, -88.3568),
      zoom: 8,
...
// SECOND MAP
  ...
  var testData2 = {
    ...
    var map2 = new L.Map('map-canvas-2', {
      center: new L.LatLng(42.6586, -88.3568),
      zoom: 8,
...
// THIRD MAP
  ...
  var testData3 = {
    ...
    var map3 = new L.Map('map-canvas-3', {
      center: new L.LatLng(42.6586, -88.3568),
      zoom: 8,
      layers: [baseLayer3, heatmapLayer3]
    });

    heatmapLayer3.setData(testData3);
